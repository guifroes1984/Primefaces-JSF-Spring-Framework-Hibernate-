...
/**
 * Método que tem que consultar no banco de dados, se o usuário relamente
 * existe.
 */
...
public class DaoLogin extends ImplementacaoCrud<Object> implements  RepositoryLogin {
	...
	public boolean autentico(String login, String senha) throws Exception {
		String sql = "select count(1) as autentica from entidade where ent_login = ? and ent_senha = ? "; /*SQL puro*/
